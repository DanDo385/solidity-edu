...
import "../src/solution/Project46Solution.sol";
...
contract Project46Test is Test {
    Project46Solution public vault;
    ...
    event ModeChanged(
        Project46Solution.Mode oldMode, Project46Solution.Mode newMode
    );
    ...
    function setUp() public {
        ...
        // Deploy vault
        vault = new Project46Solution(address(token), address(strategy));
    ...
    function test_TriggerEmergency_ManuallyByOwner() public {
        ...
        emit ModeChanged(Project46Solution.Mode.NORMAL, Project46Solution.Mode.EMERGENCY);

        vault.triggerEmergency();

        // Verify mode changed
        (Project46Solution.Mode mode,,,, bool isSolvent) = vault.getVaultStatus();
        assertEq(uint256(mode), uint256(Project46Solution.Mode.EMERGENCY));
    }
    ...
    function test_ResumeNormal_AfterRecovery() public {
        ...
        (Project46Solution.Mode mode,,,, bool isSolvent) = vault.getVaultStatus();
        assertEq(uint256(mode), uint256(Project46Solution.Mode.PAUSED));
        ...
        assertEq(uint256(mode), uint256(Project46Solution.Mode.NORMAL));
    ...
    function test_AutomaticEmergencyTrigger() public {
        ...
        // Record initial mode
        (Project46Solution.Mode modeBefore,,,, bool isSolvent) = vault.getVaultStatus();
        assertEq(uint256(modeBefore), uint256(Project46Solution.Mode.NORMAL));
