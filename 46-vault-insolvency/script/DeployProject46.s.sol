...
contract DeployProject46 is Script {
    function run() external {
        ...
        Project46Solution vault = new Project46Solution(address(token), address(strategy));
...
2. Deploy basic contracts:
   forge script script/DeployProject46.s.sol:DeployProject46 --rpc-url $RPC_URL --broadcast

3. Deploy with scenario:
   forge script script/DeployProject46.s.sol:DeployWithScenario --rpc-url $RPC_URL --broadcast

4. Local testing:
   forge script script/DeployProject46.s.sol:DeployProject46 --fork-url $RPC_URL

5. Verify contracts:
   forge verify-contract <address> Project46Solution --chain-id <id>
...
2. Deploy to local node:
   forge script script/DeployProject46.s.sol:DeployWithScenario --rpc-url http://localhost:8545 --broadcast
