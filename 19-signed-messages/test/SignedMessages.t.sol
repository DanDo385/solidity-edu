 ...
 */
contract SignedMessagesTest is Test {
    SignedMessagesSolution public project;
    ...
    function setUp() public {
        ...
        vm.prank(issuer);
        project = new SignedMessagesSolution();
    ...
    function testPermitExpired() public {
        ...
        // Should revert
        vm.expectRevert(SignedMessagesSolution.SignatureExpired.selector);
        project.permit(owner, spender, value, deadline, v, r, s);
    }
    ...
    function testPermitWrongSigner() public {
        ...
        // Should revert
        vm.expectRevert(SignedMessagesSolution.InvalidSignature.selector);
        project.permit(owner, spender, value, deadline, v, r, s);
    }
    ...
    function testMetaTxInsufficientBalance() public {
        ...
        // Should revert
        vm.expectRevert(SignedMessagesSolution.InsufficientBalance.selector);
        project.executeMetaTx(owner, spender, amount, deadline, v, r, s);
    }
    ...
    function testMetaTxZeroAddress() public {
        ...
        vm.expectRevert(SignedMessagesSolution.ZeroAddress.selector);
    ...
    function testVoucherDoubleSpend() public {
        ...
        vm.expectRevert(SignedMessagesSolution.VoucherAlreadyUsed.selector);
        project.claimVoucher(owner, amount, deadline, v, r, s);
    }
    ...
    function testDomainSeparator() public {
        bytes32 expected = keccak256(
            abi.encode(
                ...
                keccak256(bytes("SignedMessages")),
                keccak256(bytes("1")),
                block.chainid,
                address(project)
            )
    ...
    function testCrossChainReplayProtection() public {
        ...
        SignedMessagesSolution projectOtherChain = new SignedMessagesSolution();
