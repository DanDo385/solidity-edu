...
contract DeployProject19 is Script {
    function run() external {
        ...
        Project19 project19 = new Project19();
        console.log("Project19 (Skeleton) deployed at:", address(project19));

        // Deploy solution contract
        Project19Solution solution = new Project19Solution();
        console.log("Project19Solution deployed at:", address(solution));
...
/**
 * @title InteractProject19
 * @notice Script for interacting with deployed contracts
 * @dev Demonstrates signature creation and verification
 */
contract InteractProject19 is Script {
    Project19Solution public solution;

    function setUp() public {
        // Load deployed contract address
        address contractAddress = vm.envAddress("CONTRACT_ADDRESS");
        solution = Project19Solution(payable(contractAddress));
    }
