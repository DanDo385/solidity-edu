...
import "../src/solution/Project50Solution.sol";
import "@openzeppelin/contracts/proxy/ERC1967/ERC1967Proxy.sol";

/**
 * @title DeployProject50
 ...
 *
 * Usage:
 * forge script script/DeployProject50.s.sol:DeployProject50 --rpc-url $RPC_URL --broadcast --verify
 *
 * For local testing:
 * forge script script/DeployProject50.s.sol:DeployProject50 --fork-url http://localhost:8545 --broadcast
 */
contract DeployProject50 is Script {
...
contract DeployTestnet is Script {
    function run() public {
        ...
        DeployProject50 deployer = new DeployProject50();
        deployer.setUp();
        deployer.run();
