...
contract ChainlinkOracleTest is Test {
    ...
    function test_RevertWhen_PriceIsStale() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(
                ChainlinkOracleSolution.StalePrice.selector,
                2 hours
            )
        );
    ...
    function test_RevertWhen_PriceIsZero() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(ChainlinkOracleSolution.InvalidPrice.selector, int256(0))
        );
        oracle.getLatestPrice();
    }
    ...
    function test_RevertWhen_PriceIsNegative() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(ChainlinkOracleSolution.InvalidPrice.selector, int256(-100e8))
        );
        oracle.getLatestPrice();
    }
    ...
    function test_RevertWhen_PriceBelowMinimum() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(ChainlinkOracleSolution.PriceOutOfBounds.selector, 50e8)
        );
        oracle.getLatestPrice();
    }
    ...
    function test_RevertWhen_PriceAboveMaximum() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(ChainlinkOracleSolution.PriceOutOfBounds.selector, 15000e8)
        );
        oracle.getLatestPrice();
    }
    ...
    function test_RevertWhen_RoundIncomplete() public {
        ...
        vm.expectRevert(ChainlinkOracleSolution.IncompleteRound.selector);
        oracle.getLatestPrice();
    }
    ...
    function test_CircuitBreaker_TriggerOnLargeIncrease() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(
                ChainlinkOracleSolution.ExcessivePriceDeviation.selector,
                7500
            )
        );
        oracle.getLatestPrice();
    ...
    function test_RevertWhen_GetPriceWhilePaused() public {
        ...
        // Try to get price
        vm.expectRevert(ChainlinkOracleSolution.CircuitBreakerActive.selector);
        oracle.getLatestPrice();
    }
    ...
    function test_RevertWhen_NonOwnerTriggersCircuitBreaker() public {
        vm.prank(user);
        vm.expectRevert(ChainlinkOracleSolution.Unauthorized.selector);
        oracle.triggerCircuitBreaker();
    }
    ...
    function test_RevertWhen_InvalidConfigMinMaxPrice() public {
        vm.expectRevert(ChainlinkOracleSolution.InvalidConfiguration.selector);
    ...
    function test_PriceWithDifferentDecimals() public {
        ...
        ChainlinkOracleSolution newOracle = new ChainlinkOracleSolution(
