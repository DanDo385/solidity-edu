...
func main() {
	...
	// EDUCATIONAL NOTES:
	// - debug_traceTransaction replays the tx and emits a detailed execution log.
	// - Not part of standard eth namespace; often disabled on hosted RPC—use your own node or anvil.
	// - CPU analogy: instruction-by-instruction trace with gas spent per step (like a flight recorder).
	// - Builds on tx basics (module 05) and calls/logs (07/09) to debug real execution.
