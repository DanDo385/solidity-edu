 ...
 * ZPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPP]
 *
 * L Using .transfer() or .send() (breaks with smart contract wallets)
 * L Not checking .call() return value (silent failures)
 * L External calls before state updates (reentrancy vulnerability)
 * L Forgetting payable on constructor (can't fund during deployment)
 * L Using public when external would save gas
 * L Not emitting events for ETH transfers (breaks indexing)
 * L Assuming "private" means encrypted (all data is public)
 *
 * TPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPW
 * Q                          NEXT STEPS                                       Q
 * ZPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPP]
