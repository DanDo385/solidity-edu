 ...
 *
 * Usage:
 *   forge script script/DeployProject32.s.sol:DeployProject32 --rpc-url <RPC_URL> --broadcast
 *
 * Local deployment:
 *   forge script script/DeployProject32.s.sol:DeployProject32 --rpc-url http://localhost:8545 --broadcast
 *
 * Dry run (simulation):
 *   forge script script/DeployProject32.s.sol:DeployProject32 --rpc-url <RPC_URL>
 */
contract DeployProject32 is Script {
