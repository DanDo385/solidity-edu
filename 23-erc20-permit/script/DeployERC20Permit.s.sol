...
contract DeployERC20Permit is Script {
    function run() external {
        ...
        console.log("Deploying ERC20Permit - ERC-20 Permit Token...");
        ...
        ERC20PermitSolution token = new ERC20PermitSolution();
        ...
        ERC20PermitCustomImplementation customToken = new ERC20PermitCustomImplementation();
...
contract InteractWithPermit is Script {
    function run() external {
        ...
        ERC20PermitSolution token = ERC20PermitSolution(tokenAddress);
