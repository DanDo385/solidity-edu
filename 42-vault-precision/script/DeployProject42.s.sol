...
import "../src/Project42.sol";
import "../src/solution/Project42Solution.sol";
import "@openzeppelin/contracts/token/ERC20/IERC20.sol";

/**
 * @title DeployProject42
 * @notice Deployment script for ERC-4626 Precision & Rounding Vault
 *
 * USAGE:
 * Deploy skeleton:
 *   forge script script/DeployProject42.s.sol:DeployProject42 --rpc-url $RPC_URL --broadcast
 *
 * Deploy solution:
 *   forge script script/DeployProject42.s.sol:DeployProject42Solution --rpc-url $RPC_URL --broadcast
 *
 * Deploy with verification:
 *   forge script script/DeployProject42.s.sol:DeployProject42 --rpc-url $RPC_URL --broadcast --verify
 */
contract DeployProject42 is Script {
    ...
    function run() external {
        ...
        console.log("=== Deploying Project42 Vault ===");
...
/**
 * @title DeployProject42Solution
 * @notice Deployment script for the complete solution vault
 */
contract DeployProject42Solution is Script {
    address public constant DEFAULT_ASSET = 0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48;
    ...
    function run() external {
        ...
        console.log("=== Deploying Project42Solution Vault ===");
        console.log("Asset:", assetAddress);
        console.log("Name:", vaultName);
        console.log("Symbol:", vaultSymbol);
        console.log("Deployer:", msg.sender);
        ...
        Project42Solution vault = new Project42Solution(
            IERC20(assetAddress),
            vaultName,
            vaultSymbol
        );
        ...
        console.log(
            "forge verify-contract",
            address(vault),
            "src/solution/Project42Solution.sol:Project42Solution",
            "--constructor-args $(cast abi-encode 'constructor(address,string,string)'",
            assetAddress,
            vaultName,
            vaultSymbol,
