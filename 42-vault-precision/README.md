...
This project explores the critical mathematics behind ERC-4626 tokenized vaults, focusing on rounding precision and its security implications. Incorrect rounding can lead to vault insolvency, user fund loss, or exploitable attack vectors.

## Learning Objectives

- Understand rounding direction requirements in vault operations
- Implement mathematically sound preview functions
- Handle edge cases with zero denominators
- Prevent precision-based attacks
- Master mulDiv rounding modes
- Prove vault invariants hold under all conditions
