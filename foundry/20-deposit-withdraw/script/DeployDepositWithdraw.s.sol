...
/**
 * @title DeployDepositWithdraw
 * @notice Deployment script for DepositWithdraw Deposit/Withdraw Vault
 *
 * USAGE:
 * ======
 *
 ...
 *   2. Deploy: forge script script/DeployDepositWithdraw.s.sol --broadcast --rpc-url http://localhost:8545
 *
 * Testnet deployment:
 *   forge script script/DeployDepositWithdraw.s.sol --broadcast --rpc-url $RPC_URL --verify
 *
 ...
 *   TOKEN_ADDRESS=0x... forge script script/DeployDepositWithdraw.s.sol --broadcast
 *
 * Deploy and verify:
 *   forge script script/DeployDepositWithdraw.s.sol --broadcast --verify --etherscan-api-key $API_KEY
 */
contract DeployDepositWithdraw is Script {
    function run() external {
        ...
        if (tokenAddress != address(0)) {
            ...
            DepositWithdrawSolution vault = new DepositWithdrawSolution(tokenAddress);

            console.log("===============================================");
            console.log("DepositWithdraw Vault Deployed Successfully!");
            console.log("===============================================");
            ...
            DepositWithdrawSolution vault = new DepositWithdrawSolution(address(mockToken));
