 ...
 * ═══════════════════════════════════════════════════════════════════════════
 *
 * 1. ORACLE MANIPULATION IS EXTREMELY PROFITABLE
 *    ✅ Flashloans provide unlimited capital
 *    ✅ Spot prices can be manipulated in single transaction
 *    ✅ Real-world: Billions extracted via oracle attacks
 *    ✅ CONNECTION TO PROJECT 18: Chainlink oracle safety!
 *
 * 2. SPOT PRICE ORACLES ARE VULNERABLE
 *    ✅ AMM spot prices can be manipulated with large swaps
 *    ✅ Single transaction can skew price significantly
 *    ✅ Flashloans enable manipulation without capital
 *    ✅ Never use spot prices for critical operations
 *
 * 3. TWAP PREVENTS MANIPULATION
 *    ✅ Time-Weighted Average Price smooths out spikes
 *    ✅ Requires manipulation over multiple blocks
 *    ✅ Much more expensive to manipulate
 *    ✅ Standard pattern for DeFi protocols
 *
 * 4. MULTIPLE ORACLE SOURCES PROVIDE REDUNDANCY
 *    ✅ Chainlink + DEX TWAP + Fallback oracle
 *    ✅ Compare prices for consistency
 *    ✅ Revert if deviation too large
 *    ✅ Defense in depth approach
 *
 * 5. CIRCUIT BREAKERS LIMIT DAMAGE
 *    ✅ Pause operations when oracle fails
 *    ✅ Use last known good price as fallback
 *    ✅ Prevent exploitation during oracle downtime
 *    ✅ Real-world: Critical for production protocols
 *
 * 6. ORACLE SECURITY IS MULTI-LAYERED
 *    ✅ Staleness checks (time-based)
 *    ✅ Deviation checks (price-based)
 *    ✅ Completeness checks (round-based)
 ...
 * ❌ Not checking oracle staleness (using old prices!)
 * ❌ No deviation checks (extreme price swings!)
 ...
 * ═══════════════════════════════════════════════════════════════════════════
 *
 * • Study Chainlink oracle integration (Project 18)
 * • Learn about TWAP implementation details
 * • Explore multi-oracle aggregation patterns
 * • Move to Project 35 to learn about delegatecall corruption
 */
