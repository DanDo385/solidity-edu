...
import "../src/solution/ERC20PermitSolution.sol";
...
contract ERC20PermitTest is Test {
    ERC20PermitSolution public token;
    ERC20PermitCustomImplementation public customToken;
    ...
    function setUp() public {
        ...
        // Deploy contracts
        token = new ERC20PermitSolution();
        customToken = new ERC20PermitCustomImplementation();
    ...
    function testDomainSeparatorIsUnique() public {
        ...
        ERC20PermitSolution token2 = new ERC20PermitSolution();
    ...
    function testCustomImplementationRevertsOnExpiry() public {
        ...
        vm.expectRevert(ERC20PermitCustomImplementation.ERC20Permit__ExpiredDeadline.selector);
        customToken.permit(alice, spender, PERMIT_AMOUNT, deadline, v, r, s);
    }
    ...
    function _signPermit(
        ...
        if (tokenAddress == address(token)) {
            ...
            domainSeparator = ERC20PermitSolution(tokenAddress).DOMAIN_SEPARATOR();
        }
