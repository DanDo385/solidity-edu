...
/**
 * @title DeployMinimalProxy
 * @notice Deployment script for Minimal Proxy (EIP-1167) project
 * @dev Deploys implementation and factory contracts
 *
 * Usage:
 * forge script script/DeployMinimalProxy.s.sol:DeployMinimalProxy --rpc-url <your_rpc_url> --broadcast
 *
 * For local testing:
 * forge script script/DeployMinimalProxy.s.sol:DeployMinimalProxy --fork-url http://localhost:8545 --broadcast
 *
 * To verify on Etherscan:
 * forge script script/DeployMinimalProxy.s.sol:DeployMinimalProxy --rpc-url <your_rpc_url> --broadcast --verify
 */
contract DeployMinimalProxy is Script {
