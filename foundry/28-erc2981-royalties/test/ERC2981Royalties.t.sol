...
/**
 * @title ERC2981RoyaltiesTest
 * @notice Comprehensive tests for ERC-2981 royalty implementation
 */
contract ERC2981RoyaltiesTest is Test {
    ERC2981RoyaltiesSolution public nft;
    ...
    function setUp() public {
        nft = new ERC2981RoyaltiesSolution("RoyaltyNFT", "RNFT", royaltyReceiver, DEFAULT_ROYALTY_FEE);
    }
    ...
    function test_Constructor_InvalidRoyaltyFee() public {
        ...
        new ERC2981RoyaltiesSolution("Test", "TEST", royaltyReceiver, MAX_ROYALTY_FEE + 1);
    }
