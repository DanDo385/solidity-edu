 ...
 */
contract BlockTimeLogicTest is Test {
    BlockTimeLogicSolution public project;
    ...
    function setUp() public {
        // Deploy contract
        project = new BlockTimeLogicSolution();
    ...
    function testLockInVault() public {
        ...
        emit BlockTimeLogicSolution.VaultLocked(block.timestamp + lockDuration, depositAmount);
    ...
    function testCannotWithdrawWhileLocked() public {
        ...
        vm.prank(user1);
        vm.expectRevert(BlockTimeLogicSolution.VaultStillLocked.selector);
    ...
    function testCannotWithdrawFromEmptyVault() public {
        ...
        vm.expectRevert(BlockTimeLogicSolution.InsufficientBalance.selector);
        project.withdrawFromVault();
    }
    ...
    function testCannotBypassRateLimit() public {
        ...
        vm.prank(user1);
        vm.expectRevert(BlockTimeLogicSolution.RateLimitActive.selector);
        project.performRateLimitedAction();
    ...
    function testCannotInitiateCooldownTwice() public {
        ...
        vm.prank(user1);
        vm.expectRevert(BlockTimeLogicSolution.CooldownAlreadyActive.selector);
        project.initiateCooldown();
    }
    ...
    function testCannotExecuteWithoutInitiation() public {
        vm.prank(user1);
        vm.expectRevert(BlockTimeLogicSolution.CooldownNotInitiated.selector);
    ...
    function testCannotExecuteBeforeCooldownFinishes() public {
        ...
        vm.prank(user1);
        vm.expectRevert(BlockTimeLogicSolution.CooldownNotFinished.selector);
        project.executeAfterCooldown();
    ...
    function testCannotReleaseTokensTwice() public {
        ...
        vm.expectRevert(BlockTimeLogicSolution.NoTokensToRelease.selector);
        project.releaseVestedTokens();
    }
    ...
    function testCannotEnterTwice() public {
        ...
        // Second entry fails
        vm.prank(user1);
        vm.expectRevert(BlockTimeLogicSolution.AlreadyEntered.selector);
        project.enterLottery();
    }
    ...
    function testCannotEnterBeforeStart() public {
        ...
        vm.prank(user1);
        vm.expectRevert(BlockTimeLogicSolution.LotteryNotActive.selector);
        project.enterLottery();
    }
    ...
    function testCannotSelectWinnerEarly() public {
        ...
        vm.roll(149);
        vm.expectRevert(BlockTimeLogicSolution.LotteryNotEnded.selector);
        project.selectWinner();
    }
    ...
    function testCannotSelectWinnerWithNoParticipants() public {
        ...
        vm.expectRevert(BlockTimeLogicSolution.NoParticipants.selector);
        project.selectWinner();
    }
