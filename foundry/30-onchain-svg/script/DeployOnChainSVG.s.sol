...
import "../src/solution/OnChainSVGSolution.sol";

/**
 * @title DeployOnChainSVG
 * @notice Deployment script for On-Chain SVG NFT
 * @dev Deploys the contract and optionally mints test tokens
 *
 * Usage:
 *   Deploy to local:
 *     forge script script/DeployOnChainSVG.s.sol:DeployOnChainSVG --fork-url http://localhost:8545 --broadcast
 *
 *   Deploy to testnet:
 *     forge script script/DeployOnChainSVG.s.sol:DeployOnChainSVG --rpc-url sepolia --broadcast --verify
 *
 *   Deploy to mainnet (use with caution):
 *     forge script script/DeployOnChainSVG.s.sol:DeployOnChainSVG --rpc-url mainnet --broadcast --verify
 */
contract DeployOnChainSVG is Script {
    function run() external {
        ...
        OnChainSVGSolution nft = new OnChainSVGSolution();
