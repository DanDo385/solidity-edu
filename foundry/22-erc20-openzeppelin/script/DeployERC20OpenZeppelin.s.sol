...
/**
 * @title DeployERC20OpenZeppelin
 * @dev Deployment script for all OpenZeppelin ERC20 token examples
 *
 * Usage:
 *   forge script script/DeployERC20OpenZeppelin.s.sol:DeployERC20OpenZeppelin --rpc-url <RPC_URL> --broadcast --verify
 *
 * For local testing:
 *   forge script script/DeployERC20OpenZeppelin.s.sol:DeployERC20OpenZeppelin --fork-url http://localhost:8545 --broadcast
 */
contract DeployERC20OpenZeppelin is Script {
