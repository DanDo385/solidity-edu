...
import "../src/solution/MerkleAllowlistSolution.sol";

/**
 * @title MerkleAllowlistTest
...
contract MerkleAllowlistTest is Test {
    MerkleAllowlistSolution public nft;
    ...
    function setUp() public {
        ...
        nft = new MerkleAllowlistSolution(merkleRoot);
    ...
    function test_AllowlistMintEmitsEvent() public {
        ...
        emit MerkleAllowlistSolution.AllowlistMinted(user1, 0);
    ...
    function test_RevertDoubleClaim() public {
        ...
        vm.expectRevert(MerkleAllowlistSolution.AlreadyClaimed.selector);
        nft.allowlistMint(proofs[user1]);
    ...
    function test_RevertInvalidProof() public {
        ...
        vm.expectRevert(MerkleAllowlistSolution.InvalidProof.selector);
    ...
    function test_PublicMintEmitsEvent() public {
        ...
        vm.expectEmit(true, true, false, true);
        emit MerkleAllowlistSolution.PublicMinted(notAllowlisted, 0);
    ...
    function test_RevertPublicMintNotEnabled() public {
        ...
        vm.expectRevert(MerkleAllowlistSolution.PublicMintNotEnabled.selector);
        nft.publicMint{value: 0.01 ether}();
    }
    ...
    function test_RevertPublicMintIncorrectPayment() public {
        ...
        // Too little
        vm.expectRevert(MerkleAllowlistSolution.IncorrectPayment.selector);
    ...
    function test_RevertMaxSupplyReached() public {
        ...
        vm.expectRevert(MerkleAllowlistSolution.MaxSupplyReached.selector);
        nft.publicMint{value: 0.01 ether}();
    }
    ...
    function test_SetMerkleRoot() public {
        ...
        vm.prank(owner);
        vm.expectEmit(true, true, false, true);
        emit MerkleAllowlistSolution.MerkleRootUpdated(merkleRoot, newRoot);
    ...
    function test_RevertWithdrawNoBalance() public {
        vm.prank(owner);
        vm.expectRevert(MerkleAllowlistSolution.NoBalanceToWithdraw.selector);
        nft.withdraw();
    }
    ...
    function test_GasComparison_AllowlistVsMapping() public {
        ...
        gasBefore = gasleft();
        new MerkleAllowlistSolution(merkleRoot);
