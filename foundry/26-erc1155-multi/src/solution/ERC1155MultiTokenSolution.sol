 ...
 * ═══════════════════════════════════════════════════════════════════════════
 *
 * 1. ERC-1155 SUPPORTS MULTIPLE TOKEN TYPES IN ONE CONTRACT
 *    ✅ Fungible tokens (like ERC-20): Currencies, consumables
 *    ✅ Non-fungible tokens (like ERC-721): Unique items
 *    ✅ Semi-fungible tokens: Start fungible, become unique
 *    ✅ All in a single contract!
 *
 * 2. BATCH OPERATIONS SAVE GAS
 *    ✅ Transfer multiple token types in one transaction
 *    ✅ Single approval for all token types (operator)
 *    ✅ Atomic swaps (trade multiple assets at once)
 *    ✅ Reduced contract deployments
 *
 * 3. TOKEN ID ORGANIZATION MATTERS
 *    ✅ Convention: 0-999 fungible, 1000+ non-fungible
 *    ✅ Check balance to determine fungibility
 *    ✅ Balance > 1 = fungible, Balance = 0 or 1 = NFT
 *    ✅ Document your ID scheme
 *
 * 4. SAFE TRANSFER CALLBACKS ARE CRITICAL
 *    ✅ onERC1155Received for single transfers
 *    ✅ onERC1155BatchReceived for batch transfers
 *    ✅ Contracts must implement IERC1155Receiver
 *    ✅ Prevents tokens being locked in contracts
 *
 * 5. OPERATOR APPROVAL IS POWERFUL
 *    ✅ setApprovalForAll(operator, true)
 *    ✅ Operator can transfer ALL token types
 *    ✅ More powerful than ERC-20/721 approvals
 *    ✅ Use carefully!
 *
 * 6. USE CASES FOR ERC-1155
 *    ✅ Gaming items (currencies + unique items)
 *    ✅ Multi-asset systems
 *    ✅ Batch airdrops
 *    ✅ Gas-efficient token management
 *
 * ═══════════════════════════════════════════════════════════════════════════
 *                        COMMON MISTAKES
 * ═══════════════════════════════════════════════════════════════════════════
 *
 * ❌ Not implementing safe transfer callbacks (tokens locked!)
 * ❌ Confusing fungible vs non-fungible token IDs
 * ❌ Not checking return values from callbacks
 * ❌ Using wrong transfer function (safe vs unsafe)
 *
 * ═══════════════════════════════════════════════════════════════════════════
 *                          NEXT STEPS
 * ═══════════════════════════════════════════════════════════════════════════
 *
 * • Study OpenZeppelin ERC1155 implementation
 * • Explore gaming token systems
 * • Learn about batch transfer patterns
 * • Move to Project 27 to learn about Soulbound Tokens
 */
