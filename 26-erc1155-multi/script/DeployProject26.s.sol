 ...
 *
 * Usage:
 * forge script script/DeployProject26.s.sol:DeployProject26 --rpc-url <RPC_URL> --broadcast --verify
 *
 * Local deployment:
 * forge script script/DeployProject26.s.sol:DeployProject26 --fork-url http://localhost:8545 --broadcast
 */
contract DeployProject26 is Script {
    // Configuration
 ...
 *
 * Usage:
 * forge script script/DeployProject26.s.sol:DemoProject26 --rpc-url <RPC_URL> --broadcast
 */
contract DemoProject26 is Script {
    function run() external {
 ...
 *
 * Usage:
 * forge script script/DeployProject26.s.sol:VerifyProject26 --rpc-url <RPC_URL>
 */
contract VerifyProject26 is Script {
