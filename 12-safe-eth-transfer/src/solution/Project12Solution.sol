...
/**
 * @title Project12Solution - Safe ETH Transfer Library
...
contract Project12Solution is ReentrancyGuard {
    // ============================================
    // STATE VARIABLES
    // ============================================
    ...
    function withdraw() public nonReentrant {
         ...
         * READ STATE
         *
         * Cache to memory for gas efficiency:
         * - SLOAD: 2,100 gas
         * - MLOAD: 3 gas
         *
         * Reading from memory in subsequent uses saves gas.
         */
