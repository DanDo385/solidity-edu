...
/**
 * @title DeployProject12
 * @notice Deployment script for Safe ETH Transfer Library
 * @dev Demonstrates deployment and basic interactions
 *
 * USAGE:
 * Deploy to local network:
 *   forge script script/DeployProject12.s.sol --rpc-url http://localhost:8545 --broadcast
 *
 * Deploy to testnet:
 *   forge script script/DeployProject12.s.sol --rpc-url $SEPOLIA_RPC_URL --broadcast --verify
 *
 * Simulate (no broadcast):
 *   forge script script/DeployProject12.s.sol
 */
contract DeployProject12 is Script {
    // ============================================
    // STATE VARIABLES
    // ============================================
