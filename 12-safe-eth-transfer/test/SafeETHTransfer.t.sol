 ...
 */
contract SafeETHTransferTest is Test {
    // ============================================
    // STATE VARIABLES
    // ============================================
    ...
    function test_RevertIf_DepositZero() public {
        vm.prank(alice);
        vm.expectRevert(SafeETHTransferSolution.DepositZero.selector);
    ...
    function test_RevertIf_WithdrawZeroBalance() public {
        vm.prank(alice);
        vm.expectRevert(SafeETHTransferSolution.NoBalanceToWithdraw.selector);
        safeTransfer.withdraw();
    }
    ...
    function test_RevertIf_RecipientRejectsETH() public {
        ...
        vm.prank(address(rejecter));
        vm.expectRevert(SafeETHTransferSolution.TransferFailed.selector);
        safeTransfer.withdraw();
...
contract ReentrancyAttacker {
    SafeETHTransferSolution public target;
    uint256 public attackCount;

    constructor(address _target) {
        target = SafeETHTransferSolution(_target);
    }
