...
contract Project20Test is Test {
    Project20Solution public vault;
    ...
    function setUp() public {
        // Deploy contracts
        token = new MockERC20();
        vault = new Project20Solution(address(token));
    ...
    function test_Deposit_RevertsOnZeroAmount() public {
        vm.prank(alice);
        vm.expectRevert(Project20Solution.ZeroAmount.selector);
        vault.deposit(0);
    }
    ...
    function test_Withdraw_RevertsOnInsufficientShares() public {
        ...
        vm.prank(alice);
        vm.expectRevert(Project20Solution.InsufficientShares.selector);
    ...
    function test_DepositWithSlippage_Reverts() public {
        ...
        vm.expectRevert(Project20Solution.SlippageTooHigh.selector);
