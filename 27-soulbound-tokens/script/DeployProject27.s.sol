...
/**
 * @title DeployProject27
 * @notice Deployment script for Soulbound Token contracts
 * @dev Demonstrates deployment of different SBT patterns
 *
 * Usage:
 *   Deploy skeleton:
 *     forge script script/DeployProject27.s.sol:DeployProject27 --rpc-url <RPC_URL> --broadcast
 *
 *   Deploy solution:
 *     forge script script/DeployProject27.s.sol:DeployProject27Solution --rpc-url <RPC_URL> --broadcast
 *
 *   Deploy all patterns:
 *     forge script script/DeployProject27.s.sol:DeployAllPatterns --rpc-url <RPC_URL> --broadcast
 */
contract DeployProject27 is Script {
...
/**
 * @title DeployProject27Solution
 * @notice Deploy the complete solution
 */
contract DeployProject27Solution is Script {
    function run() external {
        uint256 deployerPrivateKey = vm.envUint("PRIVATE_KEY");
 ...
 *    forge script script/DeployProject27.s.sol:DeployProject27 \
 *      --rpc-url $RPC_URL \
 *      --broadcast \
 *      --verify
 *
 ...
 *    forge script script/DeployProject27.s.sol:DeployAllPatterns \
 *      --rpc-url $RPC_URL \
 *      --broadcast
 *
 * 5. INTERACT WITH DEPLOYED SBT:
 *    forge script script/DeployProject27.s.sol:InteractWithSBT \
 *      --rpc-url $RPC_URL \
 *      --broadcast
 *
 * 6. DEMO USE CASES:
 *    forge script script/DeployProject27.s.sol:DemoSBTUseCases \
 *      --rpc-url $RPC_URL \
 *      --broadcast
 *
 * 7. BATCH MINT:
 *    forge script script/DeployProject27.s.sol:MintBatchSBTs \
 *      --rpc-url $RPC_URL \
 *      --broadcast
 *
