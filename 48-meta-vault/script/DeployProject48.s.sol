...
import "../src/solution/Project48Solution.sol";
import "@openzeppelin/contracts/token/ERC20/IERC20.sol";
import "@openzeppelin/contracts/token/ERC20/extensions/IERC4626.sol";

/**
 * @title DeployProject48
 * @notice Deployment script for MetaVault
 *
 * USAGE:
 * forge script script/DeployProject48.s.sol:DeployProject48 --rpc-url <RPC_URL> --broadcast
 *
 * CONFIGURATION:
 ...
 *    VAULT_A=0x... \
 *    forge script script/DeployProject48.s.sol --rpc-url mainnet --broadcast
 *
 * 2. Deploy on testnet with configuration:
 *    forge script script/DeployProject48.s.sol --rpc-url sepolia --broadcast
 */
contract DeployProject48 is Script {
    // Configuration
    ...
    function printDeploymentInfo() internal view {
        ...
        console.log("   forge verify-contract", address(metaVault), "src/solution/Project48Solution.sol:MetaVaultSolution");
 ...
 *
 * USAGE:
 * forge script script/DeployProject48.s.sol:DeployWithMockVaults --rpc-url <RPC_URL> --broadcast
 */
