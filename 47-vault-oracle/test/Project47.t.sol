...
/**
 * @title Project47Test - Comprehensive Oracle Integration Tests
...
contract Project47Test is Test {
    Project47Solution public vault;
    ...
    function testDepositDuringEmergencyShutdown() public {
        ...
        vm.prank(alice);
        vm.expectRevert(Project47Solution.EmergencyShutdownActive.selector);
        vault.deposit(1000 * 1e18);
    }

    function testDepositZeroAmount() public {
        vm.prank(alice);
        vm.expectRevert(Project47Solution.ZeroAmount.selector);
        vault.deposit(0);
    }
    ...
    function testWithdrawInsufficientShares() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(
                Project47Solution.InsufficientShares.selector,
                1000 * 1e18,
                0
            )
        );
